...
This project was generated from `ai-project-template` version **0.8.0**. See [`.template-version`](./.template-version) for the current release. Agents can read this file to determine which conventions and files to expect.
