...
ba|## Step 3: Generate & Customize Files
...
kb|## Step 5: Cleanup & Scaffolding Removal (Required)

wl|**Goal:** Remove scaffolding files and commit the configured project.

<critical>
After setup completes, you **MUST** remove scaffolding files. This is a **mandatory** cleanup step — do not skip it.
</critical>

### Remove Scaffolding Files

gb|
lm|These files served their purpose during setup. Remove them:
